...
function verifyErrorCode(errorCode){
        switch (errorCode) {
            ...
            case 'storage/object-not-found':
                return 'Nenhum objeto foi encontrado no destino.'    
            case 'storage/bucket-not-found':
                return 'Nenhum bucket está configurado.'    
            case 'storage/project-not-found':
                return 'Nenhum projeto está configurado.'    
            case 'storage/quota-exceeded':
                return 'Sua quota no Cloud Storage foi excedida.'    
            case 'storage/unauthenticated':
                return 'Usuário não autenticado. Por favor entre e tente novamente'    
            case 'storage/unauthorized':
                return 'Ação não permitida para o usuário.'    
            case 'storage/retry-limit-exceeded':
                return 'O tempo máximo para uma operação foi excedido (upload, download, etc). Tente novamente.'
            case 'storage/invalid-checksum':
                return 'O arquivo no cliente não corresponde ao checksum do arquivo recebido pelo servidor. Tenter fazer o upload novamente.'
            case 'storage/canceled':
                return 'O usuário cancelou a operação.'
            case 'storage/invalid-event-name':
                return 'Nome do evento inválido.'
            case 'storage/invalid-url':
                return 'URL inválido provido ao método refFromURL()'
            case 'storage/invalid-argument':
                return 'O argumento passado ao método put() ou putString() é inválido.'
            case 'storage/no-default-bucket':
                return 'Nenhum bucket está configurado. Cheque o seu objeto de configurações do Firebase.'
            case 'storage/cannot-slice-blob':
                return 'Este erro ocorre quando o arquivo local foi modificado. Tente fazer o upload novamente.'
            case 'storage/server-file-wrong-size':
                return 'O tamanho do arquivo no cliente não corresponde ao arquivo recebido no servidor. Tente fazer o upload novamente.'
            default:
                return null
        }
    }
